...
while True:
    user_text = input(
        "choose to calculate the Surface Area or volume or mmmar:"
    ).strip().lower()
    if user_text in ("surface area or volume or mmmar"):
        break
    print("Please type only: surface area or volume or mmmar.")
